...
class StringWriter<false /*reuseInput*/> : public UDFOutputString {
 public:
  ...
  // vector_ should guarantee enough space for the string
  inline void setNoCopyUnsafe(const StringView& value) {
    vector_->setNoCopyUnsafe(offset_, value);
    finalized_ = true;
  }
