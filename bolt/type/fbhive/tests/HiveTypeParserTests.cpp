...
TEST(FbHive, badParse) {
  ...
  BOLT_ASSERT_THROW(
      parser.parse("uniontype< bigint , int, float"),
      "Unexpected token uniontype at < bigint , int, float");
  BOLT_ASSERT_THROW(parser.parse("badid"), "Unexpected token badid at ");
  BOLT_ASSERT_THROW(
      parser.parse("struct<int, bigint>"), "Unexpected token  bigint>");
  BOLT_ASSERT_THROW(parser.parse("list<>"), "Unexpected token list at <>");
  BOLT_ASSERT_THROW(
  ...
  BOLT_ASSERT_THROW(parser.parse("decimal(20, 10>"), "Unexpected token ");
  BOLT_ASSERT_THROW(
