...
ShuffleMemoryPool::ShuffleMemoryPool(arrow::MemoryPool* pool) : pool_(pool) {}

arrow::Status
ShuffleMemoryPool::Allocate(int64_t size, int64_t alignment, uint8_t** out) {
...
arrow::Status ShuffleMemoryPool::Reallocate(
    int64_t old_size,
    int64_t new_size,
    int64_t alignment,
    uint8_t** ptr) {
