...
class FilterProject : public Operator {
 public:
  ...
  FilterProject(
      ...
      ProjectType type = ProjectType::kDefault);
 ...
 private:
  ...
  RowVectorPtr fillCompositeOutput(
      vector_size_t size,
  ...
  const bool acceptCompositeInput_{false};
  const bool skipForCompositeInput_{false};
