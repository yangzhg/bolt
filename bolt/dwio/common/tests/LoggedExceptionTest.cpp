...
using namespace bytedance::bolt::dwio::common::exception;
using namespace bytedance::bolt;

namespace {
void testTraceCollectionSwitchControl(bool enabled) {
  // Logged exception is system type of bolt exception.
  ...
  try {
    ...
    ASSERT_TRUE(e.exceptionType() == BoltException::Type::kSystem);
