...
template <>
struct fmt::formatter<bytedance::bolt::exec::SpillOperatorGroup::State>
    : formatter<std::string> {
  auto format(
      bytedance::bolt::exec::SpillOperatorGroup::State s,
      format_context& ctx) {
    return formatter<std::string>::format(
        bytedance::bolt::exec::SpillOperatorGroup::stateName(s), ctx);
  }
};
