...
#include "bolt/dwio/common/compression/PagedInputStream.h"
...
namespace bytedance::bolt::dwio::common::compression {

using bytedance::bolt::common::CompressionKind;
 ...
 public:
  explicit LzoDecompressor(
      ...
      : LzoAndLz4DecompressorCommon{
            blockSize,
            bolt::common::CompressionKind_LZO,
            isHadoopFrameFormat,
            streamDebugInfo} {}
  ...
  uint64_t decompressInternal(
      ...
      char* dest,
      uint64_t destLength) override {
    return ::bytedance::bolt::common::compression::lzoDecompress(
