...
class OutputBufferManager {
 public:
  ...
  /// [morsel-driven] increment number of driver schedulers
  void addFinishedPushBasedDriverSchedulers(const std::string& taskId) {
    getBuffer(taskId)->addFinishedPushBasedDriverSchedulers();
  }
