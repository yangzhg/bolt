...
#include "bolt/exec/tests/SimpleAggregateFunctionsRegistration.h"
...
TEST_F(ArrayAggTest, nullBehavior) {
  ...
  testAggregations(
      {data}, {}, {"collect_list(c0)"}, {"array_sort(a0)"}, {empty});
  testAggregations({data}, {}, {"array_agg(c0)"}, {"array_sort(a0)"}, {null});
}

TEST_F(ArrayAggTest, partNullBehavior) {
  ...
  testAggregations(
      {data}, {}, {"collect_list(c0)"}, {"array_sort(a0)"}, {expected});
  testAggregations({data}, {}, {"array_agg(c0)"}, {"array_sort(a0)"}, {null});
}
