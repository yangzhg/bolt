...
class OperatorTestBase : public testing::Test,
 ...
 public:
  ...
  /// Sets up the bolt memory system.
  ///
 ...
 protected:
  ...
  std::shared_ptr<Task> assertQueryBetween(
      const core::PlanNodePtr& plan,
      const RowVectorPtr& lessResults,
      const RowVectorPtr& moreResults) {
    return test::assertQueryBetween(plan, {lessResults}, {moreResults});
  }
