...
/// show how opaque objects can be wrapped in Bolt vectors, and how they can be
...
//
// Check `bolt/docs/develop/scalar-functions.rst` for more documentation on how
...
int main(int argc, char** argv) {
  ...
  BOLT_REGISTER_VECTOR_FUNCTION(udf_map_resolver_vector, "map_resolver_vector");
...
// `bolt/examples/ExpressionEval.cpp` instead.
VectorPtr evaluate(
    const std::string& functionName,
    const std::string& argName1,
    const std::string& argName2,
