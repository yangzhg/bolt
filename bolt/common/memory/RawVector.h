...
class raw_vector {
 ...
 private:
  ...
  static inline int64_t bufferSize(int32_t capacity) {
    return (int64_t)capacity * sizeof(T) + 2 * simd::kPadding;
  }
