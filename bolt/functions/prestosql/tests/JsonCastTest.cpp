...
TEST_F(JsonCastTest, fromTimestamp) {
  testCastToJson<Timestamp>(
      ...
      {Timestamp{0, 0},
       ...
       Timestamp{-1, 9000},
       std::nullopt},
      {"1970-01-01 00:00:00.000000000"_sv,
       "1970-04-26 17:46:40.000000000"_sv,
       "1969-12-31 23:59:59.000009000"_sv,
       std::nullopt});
  testCastToJson<Timestamp>(
      TIMESTAMP(),
      {std::nullopt, std::nullopt, std::nullopt, std::nullopt},
...
TEST_F(JsonCastTest, toInteger) {
  ...
  testThrow<JsonNativeType>(
      ...
      // in order to comply with the behavior of simdjson 3.9.2
