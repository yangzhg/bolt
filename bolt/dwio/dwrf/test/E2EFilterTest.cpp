...
// this ut uses DWRF reader, not Parquet reader, not processed temporarily
TEST_F(E2EFilterTest, DISABLED_listAndMap) {
...
// this ut uses DWRF reader, not Parquet reader, not processed temporarily
TEST_F(E2EFilterTest, DISABLED_flatMapComplex) {
  constexpr auto kColumns =
      "long_val:bigint,"
...
// this ut uses DWRF reader, not Parquet reader, not processed temporarily
TEST_F(E2EFilterTest, DISABLED_subfieldsPruning) {
