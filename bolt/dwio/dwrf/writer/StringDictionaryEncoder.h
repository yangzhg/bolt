...
class StringDictionaryEncoder {
 ...
 private:
  BOLT_FRIEND_TEST(TestStringDictionaryEncoder, GetCount);
  BOLT_FRIEND_TEST(TestStringDictionaryEncoder, GetIndex);
  BOLT_FRIEND_TEST(TestStringDictionaryEncoder, GetStride);
  BOLT_FRIEND_TEST(TestStringDictionaryEncoder, Clear);
