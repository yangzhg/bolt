...
#include "bolt/dwio/parquet/arrow/FileDecryptorInternal.h"
...
#include "bolt/dwio/parquet/arrow/generated/parquet_types.h"
...
template <>
struct ThriftEnumTypeTraits<
    ::bytedance::bolt::parquet::arrow::format::Type::type> {
  using ParquetEnum = Type;
};

template <>
struct ThriftEnumTypeTraits<
    ::bytedance::bolt::parquet::arrow::format::ConvertedType::type> {
  using ParquetEnum = ConvertedType;
};

template <>
struct ThriftEnumTypeTraits<
    ::bytedance::bolt::parquet::arrow::format::FieldRepetitionType::type> {
  using ParquetEnum = Repetition;
};

template <>
struct ThriftEnumTypeTraits<
    ::bytedance::bolt::parquet::arrow::format::Encoding::type> {
  using ParquetEnum = Encoding;
};

template <>
struct ThriftEnumTypeTraits<
    ::bytedance::bolt::parquet::arrow::format::PageType::type> {
  using ParquetEnum = PageType;
};

template <>
struct ThriftEnumTypeTraits<
    ::bytedance::bolt::parquet::arrow::format::BoundaryOrder::type> {
