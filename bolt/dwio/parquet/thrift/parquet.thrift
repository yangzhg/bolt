...
namespace cpp bytedance.bolt.parquet.thrift
...
/** n-gram algorithm type annotation. **/
struct NGramAlgorithm {
  /** N-Gram **/
  1: required i32 nGram;
  2: required i32 hashes;
  3: required i32 seed;
}

/** The algorithm used in token Bloom filter. **/
union TokenBloomFilterAlgorithm {
 ...
 **/
struct CityHash {}
union TokenBloomFilterHash {
  /** Hash Strategy for Token. **/
  1: CityHash CITYHASH;
}

/**
  * Token Bloom filter header is stored at beginning of Bloom filter data of each column
  * and followed by its bitset.
  **/
struct TokenBloomFilterHeader {
  /** The size of bitset in bits **/
  1: required i64 numBits;
  /** The algorithm for setting bits. **/
  2: required TokenBloomFilterAlgorithm algorithm;
  /** The hash function used for token Bloom filter. **/
  3: required TokenBloomFilterHash hash;
  /** The compression used in the Bloom filter **/
  4: required BloomFilterCompression compression;
}
...
struct ColumnMetaData {
  ...
  /** Byte offset from beginning of file to N-Gram Bloom filter data. **/
  101: optional list<i64> token_bloom_filter_offset;
  102: optional list<i64> token_bloom_filter_length;
}
