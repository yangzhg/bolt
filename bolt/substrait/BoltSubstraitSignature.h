...
class BoltSubstraitSignature {
 public:
  /// Given a bolt type kind, return the Substrait type signature, throw if no
  ...
  /// Given a substrait type signature, return the Bolt type.
  static TypePtr fromSubstraitSignature(const std::string& signature);

  /// Given a bolt scalar function name and argument types, return the
