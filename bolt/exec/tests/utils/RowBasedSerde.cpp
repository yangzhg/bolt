...
// static
void RowBasedSerde::deserialize(
    ByteInputStream& in,
    vector_size_t index,
    BaseVector* result,
    bool exactSize) {
...
std::optional<int32_t> RowBasedSerde::compareWithNulls(
    ByteInputStream& left,
    const DecodedVector& right,
    vector_size_t index,
    CompareFlags flags) {
...
// static
uint64_t RowBasedSerde::hash(ByteInputStream& in, const Type* type) {
