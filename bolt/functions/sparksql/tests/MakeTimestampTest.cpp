...
TEST_F(MakeTimestampTest, basic) {
  ...
  // Valid cases w/o time zone argument.
  {
    ...
    auto expectedGMT = makeNullableFlatVector<Timestamp>(
        {util::fromTimestampString("2021-07-11 06:30:45.678", nullptr),
         util::fromTimestampString("2021-07-11 06:30:01", nullptr),
         util::fromTimestampString("2021-07-11 06:31:00", nullptr),
         util::fromTimestampString("2021-07-11 06:30:59.999999", nullptr),
         std::nullopt});
    ...
    auto expectedSessionTimezone = makeNullableFlatVector<Timestamp>(
        {util::fromTimestampString("2021-07-10 22:30:45.678", nullptr),
         util::fromTimestampString("2021-07-10 22:30:01", nullptr),
         util::fromTimestampString("2021-07-10 22:31:00", nullptr),
         util::fromTimestampString("2021-07-10 22:30:59.999999", nullptr),
         std::nullopt});
  ...
  // Valid cases w/ time zone argument.
  {
    ...
    auto expected = makeNullableFlatVector<Timestamp>(
        {util::fromTimestampString("2021-07-11 06:30:45.678", nullptr),
         util::fromTimestampString("2021-07-11 04:30:45.678", nullptr),
         std::nullopt});
...
TEST_F(MakeTimestampTest, errors) {
  ...
  const auto year = makeFlatVector<int32_t>(
      {bytedance::bolt::util::kMinYear - 1,
       bytedance::bolt::util::kMaxYear + 1,
       1,
       1,
       1,
       1,
