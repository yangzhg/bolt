...
/// This file uses TPC-H DBGEN to generate data encoded using Bolt Vectors.
///
...
/// Column names could go with or without prefix.
RowTypePtr getTableSchema(Table table, bool usePrefixInColumnName = false);
...
RowVectorPtr genTpchOrders(
    ...
    bool usePrefixInColumnName = false);
