...
extern template class KllSketch<
    int8_t,
    StlAllocator<int8_t>,
    std::less<int8_t>>;
extern template class KllSketch<
    int16_t,
    StlAllocator<int16_t>,
    std::less<int16_t>>;
extern template class KllSketch<
    int32_t,
    StlAllocator<int32_t>,
    std::less<int32_t>>;
extern template class KllSketch<
    int64_t,
    StlAllocator<int64_t>,
    std::less<int64_t>>;
extern template class KllSketch<float, StlAllocator<float>, std::less<float>>;
extern template class KllSketch<
    double,
    StlAllocator<double>,
    std::less<double>>;
...
#include "bolt/functions/lib/KllSketch-inl.h"
