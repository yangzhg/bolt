...
extern template std::unique_ptr<exec::Aggregate>
createNArg<MaxByNAggregate, bool>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MaxByNAggregate, ComplexType>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MaxByNAggregate, double>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MaxByNAggregate, float>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MaxByNAggregate, int16_t>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MaxByNAggregate, int32_t>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MaxByNAggregate, int64_t>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MaxByNAggregate, int8_t>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MaxByNAggregate, StringView>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MaxByNAggregate, Timestamp>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MinByNAggregate, bool>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MinByNAggregate, ComplexType>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MinByNAggregate, double>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MinByNAggregate, float>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MinByNAggregate, int16_t>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MinByNAggregate, int32_t>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MinByNAggregate, int64_t>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MinByNAggregate, int8_t>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MinByNAggregate, StringView>(TypePtr, TypePtr, const std::string&);
extern template std::unique_ptr<exec::Aggregate>
createNArg<MinByNAggregate, Timestamp>(TypePtr, TypePtr, const std::string&);
