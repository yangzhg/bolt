...
#include "bolt/dwio/dwrf/reader/ColumnReader.h"
...
TEST_P(TestColumnReader, testBooleanWithNulls) {
  ...
  EXPECT_CALL(streams_, getStreamProxy(1, proto::Stream_Kind_PRESENT, false))
      .WillRepeatedly(Return(
          new SeekableArrayInputStream(buffer1, BOLT_ARRAY_SIZE(buffer1))));
  ...
  EXPECT_CALL(streams_, getStreamProxy(1, proto::Stream_Kind_DATA, true))
      .WillRepeatedly(Return(
          new SeekableArrayInputStream(buffer2, BOLT_ARRAY_SIZE(buffer2))));
...
TEST_P(TestColumnReader, testIntegerRLEv2) {
  ...
  int32_t size = BOLT_ARRAY_SIZE(col0);
  ...
  EXPECT_CALL(streams_, getStreamProxy(1, proto::Stream_Kind_DATA, true))
      .WillRepeatedly(Return(
          new SeekableArrayInputStream(buffer0, BOLT_ARRAY_SIZE(buffer0))));
  // col_1's DATA stream
  ...
  if (useSelectiveReader()) {
    ...
    ASSERT_EQ(BOLT_ARRAY_SIZE(expects_col0), colBatch->size());
...
TEST_P(TestColumnReader, testIntDictSkipWithNulls) {
  ...
  EXPECT_CALL(
      streams_, getStreamProxy(1, proto::Stream_Kind_IN_DICTIONARY, false))
      .WillRepeatedly(Return(
          new SeekableArrayInputStream(buffer3, BOLT_ARRAY_SIZE(buffer3))));
...
TEST_P(StringReaderTests, testDictionaryWithNulls) {
  ...
  EXPECT_CALL(streams_, getStreamProxy(1, proto::Stream_Kind_LENGTH, false))
      .WillRepeatedly(Return(
          new SeekableArrayInputStream(buffer4, BOLT_ARRAY_SIZE(buffer4))));
...
TEST_P(StringReaderTests, testStringDictSkipNoNulls) {
  ...
  EXPECT_CALL(
      streams_, getStreamProxy(1, proto::Stream_Kind_IN_DICTIONARY, false))
      .WillRepeatedly(Return(
          new SeekableArrayInputStream(inDict, BOLT_ARRAY_SIZE(inDict))));
...
TEST_P(StringReaderTests, testStringDictSkipWithNulls) {
  ...
  EXPECT_CALL(streams_, getStreamProxy(1, proto::Stream_Kind_PRESENT, false))
      .WillRepeatedly(Return(
          new SeekableArrayInputStream(present, BOLT_ARRAY_SIZE(present))));
...
TEST_P(TestColumnReader, testSkipWithNulls) {
  ...
  EXPECT_CALL(
      ...
      .WillRepeatedly(Return(
          new SeekableArrayInputStream(digits, BOLT_ARRAY_SIZE(digits))));
...
TEST_P(StringReaderTests, testBinaryDirect) {
  ...
  EXPECT_CALL(streams_, getStreamProxy(1, proto::Stream_Kind_DATA, true))
      .WillRepeatedly(
          Return(new SeekableArrayInputStream(blob, BOLT_ARRAY_SIZE(blob))));
...
TEST_P(StringReaderTests, testStringDirectShortBuffer) {
  ...
  EXPECT_CALL(streams_, getStreamProxy(1, proto::Stream_Kind_DATA, true))
      .WillRepeatedly(
          Return(new SeekableArrayInputStream(blob, BOLT_ARRAY_SIZE(blob), 3)));
...
TEST_P(StringReaderTests, testStringDirectShortBufferWithNulls) {
  ...
  EXPECT_CALL(streams_, getStreamProxy(1, proto::Stream_Kind_DATA, true))
      .WillRepeatedly(Return(
          new SeekableArrayInputStream(blob, BOLT_ARRAY_SIZE(blob), 30)));
...
TEST_P(StringReaderTests, testStringDirectNullAcrossWindow) {
  ...
  EXPECT_CALL(streams_, getStreamProxy(1, proto::Stream_Kind_PRESENT, false))
      .WillRepeatedly(Return(
          new SeekableArrayInputStream(isNull, BOLT_ARRAY_SIZE(isNull))));

  const char blob[] = "abcdefg";
  EXPECT_CALL(streams_, getStreamProxy(1, proto::Stream_Kind_DATA, true))
      .WillRepeatedly(
          Return(new SeekableArrayInputStream(blob, BOLT_ARRAY_SIZE(blob), 4)));

  // [1] * 7
  const unsigned char lenData[] = {0x04, 0x00, 0x01};
  EXPECT_CALL(streams_, getStreamProxy(1, proto::Stream_Kind_LENGTH, true))
      .WillRepeatedly(Return(
          new SeekableArrayInputStream(lenData, BOLT_ARRAY_SIZE(lenData))));
...
TEST_P(TestColumnReader, testFloatBatchNotAligned) {
  ...
  EXPECT_CALL(streams_, getStreamProxy(1, proto::Stream_Kind_DATA, true))
      .WillRepeatedly(Return(new SeekableArrayInputStream(
          byteValues,
          BOLT_ARRAY_SIZE(byteValues),
          BOLT_ARRAY_SIZE(byteValues) / 2)));
...
TEST_P(TestColumnReader, testTimestampSkipWithNulls) {
  ...
  const std::array<const char*, 4> expected{
      {"Fri May 10 09:40:50 2013\n",
       "Wed Jun 11 10:41:51 2014\n",
       "Sun Jul 12 11:42:52 2015\n",
       "Sat Aug 13 12:43:53 2016\n"}};
...
TEST_P(TestColumnReader, testDecimal64) {
  ...
  EXPECT_CALL(streams_, getStreamProxy(1, proto::Stream_Kind_DATA, true))
      .WillRepeatedly(Return(new SeekableArrayInputStream(
          numBuffer, BOLT_ARRAY_SIZE(numBuffer), 3)));
...
TEST_P(TestColumnReader, testDecimal64WithSkip) {
  ...
  EXPECT_CALL(streams_, getStreamProxy(1, proto::Stream_Kind_PRESENT, false))
      .WillRepeatedly(Return(new SeekableArrayInputStream(
          presentBuffer, BOLT_ARRAY_SIZE(presentBuffer))));
  ...
  EXPECT_CALL(streams_, getStreamProxy(1, proto::Stream_Kind_DATA, true))
      .WillRepeatedly(Return(
          new SeekableArrayInputStream(numBuffer, BOLT_ARRAY_SIZE(numBuffer))));
...
TEST_P(TestColumnReader, testLargeSkip) {
  ...
  EXPECT_CALL(streams_, getStreamProxy(1, proto::Stream_Kind_LENGTH, true))
      .WillRepeatedly(Return(
          new SeekableArrayInputStream(length, BOLT_ARRAY_SIZE(length))));
