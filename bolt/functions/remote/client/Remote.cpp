...
#include "bolt/functions/remote/client/ThriftClient.h"
#include "bolt/functions/remote/if/GetSerde.h"
#include "bolt/functions/remote/if/gen-cpp2/RemoteFunctionServiceAsyncClient.h"
...
class RemoteFunction : public exec::VectorFunction {
 public:
  ...
  // TODO: The values for these flags should be obtained from the
