...
struct ResultOrError {
  RowVectorPtr result;
  std::exception_ptr userExceptionPtr;

  std::optional<bool> resultMatch;
  std::optional<bool> haveUserException;
  std::optional<bool> userExceptionMatch;
  std::optional<bool> haveUnexpectedException;
};
