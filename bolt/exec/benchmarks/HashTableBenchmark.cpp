...
struct HashTableBenchmarkParams {
  ...
  HashTableBenchmarkParams(
      ...
      int32_t _numWays = 10,
      bool enableJitRowEqVectors = false)
      : title(std::move(title)),
        ...
        enableJitRowEqVectors(enableJitRowEqVectors) {}
...
struct HashTableBenchmarkRun {
  ...
  // __rdtsc clocks per hashed probe row. Same for Bolt and F14 cases.
  float hashClocks{0};
