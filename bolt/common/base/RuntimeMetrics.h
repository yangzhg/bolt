...
/// Simple interface to implement writing of runtime stats to Bolt Operator
/// stats.
...
/// thread.
/// NOTE: This is only used by the Bolt Driver at the moment, which ensures the
...
template <>
struct fmt::formatter<bytedance::bolt::RuntimeCounter::Unit> : formatter<int> {
  auto format(bytedance::bolt::RuntimeCounter::Unit s, format_context& ctx)
      const {
