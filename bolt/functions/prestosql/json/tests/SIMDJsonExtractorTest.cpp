...
using bytedance::bolt::functions::simdJsonExtract;
...
class SIMDJsonExtractorTest : public testing::Test {
 public:
  void expectThrowInvalidArgument(
    ...
    EXPECT_THROW(testExtract(json, path, std::nullopt), BoltUserError);
  }
    ...
    auto consumer = [&actual, &resultPopulated](auto& v) {
      ...
      switch (vtype) {
        ...
        case simdjson::ondemand::json_type::string: {
          SIMDJSON_ASSIGN_OR_RAISE(actual, v.get_string(true));
          break;
        }
