...
#include "bolt/functions/prestosql/Probability.h"

namespace bytedance::bolt::functions {

namespace {

void registerProbabilityFunctionsInternal(const std::string& prefix) {
...
void registerProbabilityFunctions(const std::string& prefix = "") {
  registerProbabilityFunctionsInternal(prefix);
}
