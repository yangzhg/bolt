...
class FieldLastNonNullValueAgg : public AggregateFunction {
  VectorPtr value_;
  size_t rowIndex_;
...
std::shared_ptr<AggregateFunction> createFieldLastNonNullValueAgg() {
  return std::make_shared<FieldLastNonNullValueAgg>();
}
