...
template <>
struct fmt::formatter<bytedance::bolt::VectorSerde::Kind>
    : formatter<std::string> {
  auto format(bytedance::bolt::VectorSerde::Kind s, format_context& ctx) const {
    return formatter<std::string>::format(
        bytedance::bolt::VectorSerde::kindName(s), ctx);
  }
};
