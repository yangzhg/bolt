...
TEST_F(TypeParserTest, invalidType) {
  ...
  BOLT_ASSERT_THROW(parseType("array()"), "Failed to parse type [array()]");

  BOLT_ASSERT_THROW(parseType("map()"), "Failed to parse type [map()]");

  BOLT_ASSERT_THROW(parseType("x"), "Failed to parse type [x]");
...
TEST_F(TypeParserTest, decimalType) {
  ...
  BOLT_ASSERT_THROW(parseType("decimal"), "Failed to parse type [decimal]");
  BOLT_ASSERT_THROW(parseType("decimal()"), "Failed to parse type [decimal()]");
  BOLT_ASSERT_THROW(
