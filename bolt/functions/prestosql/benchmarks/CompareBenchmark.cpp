 ...
 public:
  ...
  VectorPtr makeData() {
    ...
    return vectorMaker_.flatVector<int64_t>(
        ...
        bytedance::bolt::test::VectorMaker::nullEvery(5));
  }
...
BENCHMARK_MULTI(Eq_Bolt) {
  CompareBenchmark benchmark;
  return benchmark.run("==");
}

BENCHMARK_MULTI(Eq_FastBoltInBoltOut) {
  CompareBenchmark benchmark;
  return benchmark.runFastBoltInBoltOut();
}

BENCHMARK_MULTI(Eq_FastBoltInStdOut) {
  CompareBenchmark benchmark;
  return benchmark.runFastBoltInStdOut();
}
...
BENCHMARK_MULTI(Neq_Bolt) {
  CompareBenchmark benchmark;
  return benchmark.run("=");
}

BENCHMARK_MULTI(Gt_Bolt) {
  CompareBenchmark benchmark;
  return benchmark.run(">");
}
} // namespace
