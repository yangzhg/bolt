 ...
 public:
  ...
  void runTest(
    ...
    WriterContext context{
        config_,
        bolt::memory::memoryManager()->addRootPool("WriterEncodingIndexTest2")};
    context.initBuffer();
...
BOLT_TYPED_TEST_SUITE(FloatColumnWriterEncodingIndexTest, FloatTypes);
