...
using bytedance::bolt::dwio::common::BufferedOutputStream;
using bytedance::bolt::dwio::common::PositionRecorder;
...
class IntEncoder {
 ...
 private:
  ...
  BOLT_FRIEND_TEST(TestIntEncoder, TestVarIntEncoder);
};
