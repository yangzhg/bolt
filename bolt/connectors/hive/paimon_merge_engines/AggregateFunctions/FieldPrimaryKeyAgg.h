...
class FieldPrimaryKeyAggregateFunction : public AggregateFunction {
  VectorPtr value_;
  size_t rowIndex_;
...
std::shared_ptr<AggregateFunction> createFieldPrimaryKeyAggregator() {
  return std::make_shared<FieldPrimaryKeyAggregateFunction>();
}
