...
TEST(DecimalTest, divideWithRoundUp) {
  int128_t r = 0;
  DecimalUtil::divideWithRoundUp<int128_t, int64_t, int128_t>(
      r, 1, 71341000000, false, 20, 10);
  EXPECT_EQ(r, 1401718507);
  DecimalUtil::divideWithRoundUp<int128_t, int64_t, int128_t>(
      r, 1, 72689000000, false, 20, 10);
  EXPECT_EQ(r, 1375723975);
}
