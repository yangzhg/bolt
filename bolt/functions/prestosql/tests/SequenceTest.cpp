...
TEST_F(SequenceTest, timestampYearMonthStep) {
  const auto startVector = makeFlatVector<Timestamp>(
      {bytedance::bolt::util::fromTimestampString(
           "1975-01-31 10:00:00.500", nullptr),
       bytedance::bolt::util::fromTimestampString(
           "1975-03-15 10:10:10.200", nullptr),
       bytedance::bolt::util::fromTimestampString(
           "2023-12-31 23:00:00.500", nullptr)});
  const auto stopVector = makeFlatVector<Timestamp>(
      {bytedance::bolt::util::fromTimestampString(
           "1975-06-01 01:00:00.500", nullptr),
       bytedance::bolt::util::fromTimestampString(
           "1974-12-15 10:20:00.500", nullptr),
       bytedance::bolt::util::fromTimestampString(
           "2024-05-31 10:00:00.500", nullptr)});
  ...
  const auto expected = makeArrayVector<Timestamp>(
      {// last day of Feb
       {bytedance::bolt::util::fromTimestampString(
            "1975-01-31 10:00:00.500", nullptr),
        bytedance::bolt::util::fromTimestampString(
            "1975-02-28 10:00:00.500", nullptr),
        bytedance::bolt::util::fromTimestampString(
            "1975-03-31 10:00:00.500", nullptr),
        bytedance::bolt::util::fromTimestampString(
            "1975-04-30 10:00:00.500", nullptr),
        bytedance::bolt::util::fromTimestampString(
            "1975-05-31 10:00:00.500", nullptr)},
       ...
       {bytedance::bolt::util::fromTimestampString(
            "1975-03-15 10:10:10.200", nullptr),
        bytedance::bolt::util::fromTimestampString(
            "1975-02-15 10:10:10.200", nullptr),
        bytedance::bolt::util::fromTimestampString(
            "1975-01-15 10:10:10.200", nullptr)},
       // leap year
       // result won't include 2024-05-31 10:00:00.500
       {bytedance::bolt::util::fromTimestampString(
            "2023-12-31 23:00:00.500", nullptr),
        bytedance::bolt::util::fromTimestampString(
            "2024-02-29 23:00:00.500", nullptr),
        bytedance::bolt::util::fromTimestampString(
            "2024-04-30 23:00:00.500", nullptr)}});
  testExpression(
      "sequence(C0, C1, C2)", {startVector, stopVector, stepVector}, expected);
}
...
TEST_F(SequenceTest, timestampIntervalExceedMaxEntries) {
  ...
  const auto stopVector = makeFlatVector<Timestamp>(
      {bytedance::bolt::util::fromTimestampString(
           "3975-06-01 01:00:00.500", nullptr),
       bytedance::bolt::util::fromTimestampString(
           "3974-12-15 10:20:00.500", nullptr),
       bytedance::bolt::util::fromTimestampString(
           "4024-05-31 10:00:00.500", nullptr)});
