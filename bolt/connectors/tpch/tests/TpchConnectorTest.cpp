...
TEST_F(TpchConnectorTest, DISABLED_simple) {
...
TEST_F(TpchConnectorTest, DISABLED_singleColumn) {
  auto plan =
...
TEST_F(TpchConnectorTest, DISABLED_singleColumnWithAlias) {
...
TEST_F(TpchConnectorTest, DISABLED_simpleAggregation) {
  BOLT_ASSERT_THROW(
...
TEST_F(TpchConnectorTest, DISABLED_lineitemTinyRowCount) {
...
TEST_F(TpchConnectorTest, DISABLED_unknownColumn) {
  EXPECT_THROW(
      {
        PlanBuilder()
...
TEST_F(TpchConnectorTest, DISABLED_multipleSplits) {
  auto plan = PlanBuilder()
                  .tpchTableScan(
                      Table::TBL_NATION,
                      {"n_nationkey", "n_name", "n_regionkey", "n_comment"})
...
TEST_F(TpchConnectorTest, DISABLED_join) {
...
TEST_F(TpchConnectorTest, DISABLED_orderDateCount) {
  auto plan = PlanBuilder()
