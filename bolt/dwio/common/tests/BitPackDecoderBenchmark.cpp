...
#ifdef __BMI2__
#include "bolt/dwio/common/tests/Lemire/bmipacking32.h"
#endif

#include "bolt/dwio/common/tests/Lemire/FastPFor/bitpackinghelpers.h"
...
using RowSet = folly::Range<const bytedance::bolt::vector_size_t*>;
...
template <typename T>
void boltBitUnpack(uint8_t bitWidth, T* result) {
...
#else
  BOLT_FAIL("bmiunpack32 is not supported on this platform.");
#endif
}
...
#define BENCHMARK_UNPACK_FULLROWS_CASE_8(width)                  \
  BENCHMARK(bolt_unpack_fullrows_##width##_8) {                  \
    boltBitUnpack<uint8_t>(width, result8.data());               \
  }                                                              \
...
#define BENCHMARK_UNPACK_FULLROWS_CASE_16(width)                  \
  BENCHMARK(bolt_unpack_fullrows_##width##_16) {                  \
    boltBitUnpack<uint16_t>(width, result16.data());              \
  }                                                               \
...
#define BENCHMARK_UNPACK_FULLROWS_CASE_32(width)                  \
  BENCHMARK(bolt_unpack_fullrows_##width##_32) {                  \
    boltBitUnpack<uint32_t>(width, result32.data());              \
  }                                                               \
...
void naiveDecodeBitsLE(
  ...
  if (anyUnsafe) {
    ...
    for (auto i = numSafeRows; i < numRows; ++i) {
      ...
      auto byte = bit / 8;
      auto shift = bit & 7;
      result[i] = bytedance::bolt::dwio::common::safeLoadBits(
                      reinterpret_cast<const char*>(bits) + byte,
                      shift,
                      bitWidth,
                      lastSafeWord) &
...
============================================================================
bolt_unpack_fullrows_1_8                                 314.64us     3.18K
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_2_8                                 434.85us     2.30K
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_3_8                                 323.24us     3.09K
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_4_8                                 356.01us     2.81K
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_5_8                                 358.09us     2.79K
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_6_8                                 429.08us     2.33K
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_7_8                                 472.86us     2.11K
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_8_8                                 420.84us     2.38K
...
----------------------------------------------------------------------------
----------------------------------------------------------------------------
bolt_unpack_fullrows_1_16                                668.27us     1.50K
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_2_16                                725.07us     1.38K
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_3_16                                768.55us     1.30K
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_4_16                                844.47us     1.18K
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_5_16                                876.32us     1.14K
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_6_16                                986.12us     1.01K
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_7_16                                  1.21ms    828.23
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_8_16                                990.48us     1.01K
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_9_16                                  1.20ms    831.97
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_10_16                                 1.16ms    863.83
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_11_16                                 1.40ms    714.78
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_12_16                                 1.32ms    758.24
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_13_16                                 1.61ms    620.98
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_14_16                                 1.84ms    544.93
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_15_16                                 1.64ms    610.46
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_16_16                                 1.33ms    750.01
...
----------------------------------------------------------------------------
----------------------------------------------------------------------------
bolt_unpack_fullrows_1_32                                  1.67ms    598.18
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_2_32                                  1.62ms    618.83
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_3_32                                  1.64ms    608.80
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_4_32                                  1.59ms    630.64
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_5_32                                  1.61ms    622.75
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_6_32                                  1.70ms    587.36
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_7_32                                  1.79ms    559.53
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_8_32                                  1.87ms    535.47
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_9_32                                  1.83ms    547.37
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_10_32                                 1.98ms    505.99
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_11_32                                 2.14ms    467.11
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_13_32                                 2.19ms    455.93
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_15_32                                 2.36ms    424.53
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_17_32                                 2.51ms    398.07
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_19_32                                 2.66ms    376.33
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_21_32                                 2.78ms    359.64
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_24_32                                 2.77ms    360.47
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_28_32                                 2.91ms    343.95
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_30_32                                 3.03ms    329.76
...
----------------------------------------------------------------------------
bolt_unpack_fullrows_32_32                                 3.25ms    307.57
