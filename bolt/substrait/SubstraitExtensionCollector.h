...
/// Hash function of bytedance::bolt::substrait::ExtensionFunctionId.
template <>
struct hash<bytedance::bolt::substrait::ExtensionFunctionId> {
  size_t operator()(
      const bytedance::bolt::substrait::ExtensionFunctionId& k) const {
