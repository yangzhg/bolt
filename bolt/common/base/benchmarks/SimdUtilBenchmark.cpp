...
#define BOLT_BENCHMARK(_type, _name, ...) \
...
int main(int argc, char* argv[]) {
  ...
  BOLT_BENCHMARK(LeadingMask<int32_t>, leadingMaskInt32, gen);
  BOLT_BENCHMARK(LeadingMask<int64_t>, leadingMaskInt64, gen);
  BOLT_BENCHMARK(FromBitMask<int32_t>, fromBitMaskInt32, gen);
  BOLT_BENCHMARK(FromBitMask<int64_t>, fromBitMaskInt64, gen);
  folly::runBenchmarks();
  return 0;
}
